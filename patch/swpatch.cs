...
class SWPatch
{
    ...
    static int Main(string[] args)
    {
        ...
        string outPath = args.Length > 1 ? args[1] : @"C:\Users\<user>\zdlRepository\playground\spacewalker_patch\SpaceWalker.exe.patched";
        string tmp = args.Length > 2 ? args[2] : @"C:\Users\<user>\zdlRepository\playground\spacewalker_patch\bundle_extracted";
