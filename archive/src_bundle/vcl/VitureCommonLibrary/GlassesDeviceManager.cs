...
public class GlassesDeviceManager : INotifyPropertyChanged
{
	...
	private static R6NewerDisplayMode PickNativeDisplayMode(bool ultraWide, bool use1200)
	{
		if (ultraWide)
		{
			if (!use1200)
			{
				return R6NewerDisplayMode.NATIVE_DISPLAY_MODE_ULTRAWIDE_3840_1080_60HZ;
			}
			return R6NewerDisplayMode.NATIVE_DISPLAY_MODE_ULTRAWIDE_3840_1200_60HZ;
		}
		if (!use1200)
		{
			return R6NewerDisplayMode.NATIVE_DISPLAY_MODE_1920_1080_60HZ;
		}
		return R6NewerDisplayMode.NATIVE_DISPLAY_MODE_1920_1200_60HZ;
	}
